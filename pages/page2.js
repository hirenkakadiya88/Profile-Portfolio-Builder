...
function passvalues(){
    ...
    // expi. 2
    let title_22=document.getElementById("title_1").value;
    ...
    let start_month_22=document.getElementById("start_month_1").value;
    localStorage.setItem("start_month2", start_month_22);

    let start_year_22=document.getElementById("start_year_1").value;
    localStorage.setItem("start_year2", start_year_22);

    let end_month_22=document.getElementById("end_month_1").value;
    localStorage.setItem("end_month2", end_month_22);

    let end_year_22=document.getElementById("end_year_1").value;
